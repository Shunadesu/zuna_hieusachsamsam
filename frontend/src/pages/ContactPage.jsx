    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-white border border-green-100 rounded-2xl shadow-sm p-6 md:p-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Cần hỗ trợ đơn hàng, tư vấn chọn sách hoặc thanh lý sách? Đội ngũ của
          Hiệu Sách Mỹ Hạnh luôn sẵn sàng hỗ trợ bạn nhanh nhất có thể.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="rounded-xl border border-green-100 bg-green-50 p-4">
            ...
            <a
              ...
              className="flex items-center gap-2 font-semibold text-green-800 mt-1 hover:opacity-80 transition"
            >
              <FaMapLocation className="w-4 h-4 shrink-0" />
        ...
        <div className="space-y-2 text-gray-700 mb-6">
          <p>
            <span className="font-semibold text-green-800">Số điện thoại:</span>{" "}
            {siteConfig?.phone || "0900 000 000"}
          </p>
          <p>
            <span className="font-semibold text-green-800">Zalo:</span>{" "}
            {siteConfig?.zaloUrl || "Đang cập nhật"}
          </p>
          <p>
            <span className="font-semibold text-green-800">Email:</span>{" "}
            lienhe@hieusachmyhanh.vn
          </p>
          <p>
            <span className="font-semibold text-green-800">Facebook:</span>{" "}
            {siteConfig?.facebookUrl || "Đang cập nhật"}
          </p>
          <p>
            <span className="font-semibold text-green-800">Instagram:</span>{" "}
            {siteConfig?.instagramUrl || "Đang cập nhật"}
          </p>
          <p>
            <span className="font-semibold text-green-800">TikTok:</span>{" "}
            {siteConfig?.tiktokUrl || "Đang cập nhật"}
          </p>
        </div>
